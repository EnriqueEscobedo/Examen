package com.mx.consul.med.exam.web.advice;

import com.mx.consul.med.exam.model.ResponseError;
import com.mx.consul.med.exam.service.exception.BadRequestException;
import com.mx.consul.med.exam.service.exception.UnknownResourceException;
import com.mx.consul.med.exam.service.exception.ValidacionException;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<ResponseError> handleSQLException(final Exception ex, final WebRequest request) {
		logger.error("SQLException Occured:: URL " + request.getContextPath());
